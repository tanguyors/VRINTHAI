              ...
              {mainCities.map((city, i) => {
                ...
                return city.highlight ? (
                  ...
                  <motion.div
                    ...
                    className="group relative bg-white/5 backdrop-blur-md border border-white/10 rounded-[2.5rem] p-8 hover:border-[#ff8c42]/40 transition-all duration-500 hover:shadow-[0_20px_50px_rgba(255,140,66,0.15)] overflow-hidden flex flex-col justify-between"
                  >
